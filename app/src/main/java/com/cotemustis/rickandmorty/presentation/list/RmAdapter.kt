...
class RmAdapter @Inject constructor(
    ...
    private val diffCallback = object : DiffUtil.ItemCallback<com.cotemustis.rickandmorty.data.model.CharacterData>() {
        override fun areItemsTheSame(oldItem: com.cotemustis.rickandmorty.data.model.CharacterData, newItem: com.cotemustis.rickandmorty.data.model.CharacterData): Boolean {
            return oldItem == newItem
        }

        override fun areContentsTheSame(oldItem: com.cotemustis.rickandmorty.data.model.CharacterData, newItem: com.cotemustis.rickandmorty.data.model.CharacterData): Boolean {
            return oldItem == newItem
        }
    }
    ...
    var characters: List<com.cotemustis.rickandmorty.data.model.CharacterData>
