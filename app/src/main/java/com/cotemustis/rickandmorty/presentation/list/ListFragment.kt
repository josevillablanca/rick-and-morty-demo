...
import com.cotemustis.rickandmorty.databinding.RmListFragmentBinding
import com.cotemustis.rickandmorty.utils.visible
...
class ListFragment : Fragment() {
    ...
    private fun setData(data: com.cotemustis.rickandmorty.data.model.CharactersResponseData?) {
        if (data == null) {
